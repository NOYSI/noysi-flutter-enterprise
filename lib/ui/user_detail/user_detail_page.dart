...
class _UserDetailState extends StateWithBloC<UserDetailPage, UserDetailBloC>
  ...
  StreamSubscription? ssPresenceChange, ssMemberDisabledEnabled;
  ...
  Widget buildWidget(BuildContext context) {
    return Stack(
      children: <Widget>[
        TXMainAppBarWidget(
          title: member.active ? CommonUtils.getMemberNameSingle(member) ?? "" : R.string.inactiveMember,
          actions: <Widget>[
            widget.memberModel.id != bloc.userId
                ? Container(
                    ...
                    child: TXIconButtonWidget(
                      ...
                      onPressed: () {
                        if (widget.memberModel.id != bloc.userId &&
