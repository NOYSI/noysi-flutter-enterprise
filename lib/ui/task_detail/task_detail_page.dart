...
class _TaskDetailState extends StateWithBloC<TaskDetailPage, TaskDetailBloC> {
  ...
  final _keyFormEditName = new GlobalKey<FormState>();
  final _keyFormEditDescription = new GlobalKey<FormState>();
  final _keyFormExternalMails = new GlobalKey<FormState>();
            ...
            StreamBuilder<bool>(
                ...
                builder: (context, snapshotEditDescription) {
                  textEditingControllerDescription.text =
                      bloc.taskDetailUIModel.taskModel.description;
                  return Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          bloc.taskUpdateProtected ||
                              ...
                              : InkWell(
                                  ...
                                  onTap: () {
                                    bloc.changeEditModeDescription(true);
                                  },
                                ),
                        ],
                      ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TXButtonWidget(
                                          onPressed: () {
                                            bloc.changeEditModeDescription(
                                                false);
                                          },
                                          mainColor: R.color.grayLightestColor,
                                          title: R.string.cancel,
                                        ...
                                        TXButtonWidget(
                                          onPressed: () {
                                            if (_keyFormEditDescription
                                                .currentState
                                                !.validate())
                                              bloc.updateDescription(
                                                  textEditingControllerDescription
                                                      .text);
                                          },
                                          title: R.string.update,
                          ...
                          : Wrap(
                              ...
                              children: [
                                bloc.taskDetailUIModel.taskModel
                                    ...
                                    : htmlWidget(bloc.taskDetailUIModel
                                            .taskModel.htmlDescription?.html ??
                                        bloc.taskDetailUIModel.taskModel
                                            .description),
                              ],
                            ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                htmlWidget(element.parsedComment),
                SizedBox(
                  height: 5,
                ),
                TXTextWidget(
            ...
            child: TXMenuOptionItemWidget(
              ...
              onTap: () async {
                ...
                final res = await NavigationUtils.push(
                    ...
                    TaskCommentAddEditPageWidget(
                      taskModel: bloc.taskDetailUIModel.taskModel,
                      taskTimeLineModel: timelineModel,
                    ));
                if (res is bool) {
                  bloc.getTask();
                }
    ...
    return TXHtmlWidget(
      ...
      style: {
        "div.mobile-description":
            Style(color: R.color.primaryDarkColor, fontSize: FontSize(19)),
        "a": Style(
