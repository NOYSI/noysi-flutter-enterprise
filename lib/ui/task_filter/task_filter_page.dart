                                    ...
                                    children: [
                                      ...
                                      snapshot.data?.assignee != null
                                        ...
                                        children: [
                                          ...
                                          TXTextWidget(
                                            text: snapshot.data?.assignee?.active == false ? R.string.inactiveMember : CommonUtils.getMemberNameSingle(snapshot.data?.assignee) ??
                                                "",
                                            color: snapshot.data?.assignee?.active == false ? Colors.redAccent : null,
                                            fontStyle: snapshot.data?.assignee?.active == false ? FontStyle.italic : null,
                                          ),
                                          TXIconButtonWidget(
                                            icon: Icon(
                                              Icons.remove_circle,
                                                ...
                                                ? Wrap(
                                                    ...
                                                    children: [
                                                      ...
                                                      TXTextWidget(
                                                        ...
                                                        color: snapshot
                                                            .data
                                                            ?.author?.active == false ? Colors.redAccent : null,
                                                        fontStyle: snapshot
                                                            .data
                                                            ?.author?.active == false ? FontStyle.italic : null,
                                                      ),
                                                      TXIconButtonWidget(
                                                        icon: Icon(
                                                          Icons.remove_circle,
