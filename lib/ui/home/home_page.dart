...
//                  Fluttertoast.showToast(msg: drawerChat.title.toString());
                                ...
                                onNavigationOptionTap: (option) async {
                                  ...
                                  if (option ==
                                    ...
                                    NavigationUtils.push(context, TaskPage());
                                  } else if (option ==
    ...
    message.reactions.forEach((element) {
      if (element.userIds.isNotEmpty) {
        final w = InkWell(
          ...
          child: Container(
            width: element.userIds.length < 10
                ? 45
                : element.userIds.length >= 100
                    ? 60
                    : 50,
