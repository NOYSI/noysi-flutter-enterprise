...
class _SearchUserPageState
          ...
          builder: (ctx, snapshot) {
            ...
            return TXPullToRefreshWidget(
              ...
              onLoadMore: (_controller) async {
                ///Implement when api set offset ready to use for UserGroupBy.Channel.
                //await bloc.loadMembers();
                // if(widget.userGroupBy == UserGroupBy.team)
                //   await bloc.loadMembers();
  ...
  Widget _getUserWidget(MemberModel memberModel) {
    bool memberIsActive = (memberModel.active);
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          height: memberIsActive ? 5 : 0,
                        ),
                        memberIsActive && memberModel.profile?.position?.isNotEmpty == true
                            ? TXTextWidget(
