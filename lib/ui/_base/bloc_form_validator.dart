...
const strongPassword =
    "^(?=.[0-9])(?=.[a-z\u0430-\u044F])(?=.[A-Z\u0410-\u042F])(?=.[^a-zA-Z0-9\u0430-\u044F\u0410-\u042F]).{10,200}\$";
const mediumPassword =
    "^(?=.[0-9])(?=.[a-z\u0430-\u044F])(?=.*[A-Z\u0410-\u042F]).{8,200}\$";
...
class FormValidatorBloC {
  ...
  FormFieldValidator alphanumericRoomNameWithoutSpaces() {
    FormFieldValidator validator = (value) {
      return (value?.toString().trim().isEmpty == true)
          ...
          : !GlobalRegexp.genericNameWithoutSpace
  ...
  ///Name of teams, private groups, channels, folders, meeting url
