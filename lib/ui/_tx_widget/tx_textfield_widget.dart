...
class TXTextFieldWidget extends StatefulWidget {
  ...
  final bool enabled;
  final InputBorder? border, errorBorder, focusedBorder, enabledBorder;
  ...
  const TXTextFieldWidget(
      ...
      this.cursorColor,
      this.textColor,
      this.labelColor, this.border, this.errorBorder, this.focusedBorder, this.enabledBorder})
      : super(key: key);
...
class _TXTextFieldWidgetState extends State<TXTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: TextStyle(color: widget.textColor ?? R.color.grayDarkColor, fontSize: 18),
      decoration: InputDecoration(
          hintText: widget.hintText,
          hintStyle:
              TextStyle(color: widget.hintColor ?? R.color.grayDarkColor, fontSize: 18),
          contentPadding: widget.contentPadding ??
              EdgeInsets.symmetric(vertical: 6, horizontal: 8),
          labelText: widget.label,
          labelStyle:
              TextStyle(color: widget.labelColor ?? R.color.grayDarkColor),
          errorMaxLines: 7,
