...
class FilesExplorerBloC extends BaseBloC with LoadingBloC, ErrorHandlerBloC {
  ...
  void initView(
    ...
    members.forEach((member) {
      ...
      if (ch != null) {
        ...
        if(member.id == RemoteConstants.nosyiRobot) {
          noysi = ch;
        }
      }
    });
    ...
    if (noysi != null) {
      ...
      isLoading = true;
      final resNoysi = await _iUserRepository.getTeamMember(teamId, RemoteConstants.nosyiRobot);
