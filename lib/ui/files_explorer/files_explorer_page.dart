          ...
          child: TXBreadCrumbItemWidget(
            ...
            onTap: () {
              if (model!.id == bloc.fileModelUI.currentParentContainer!.id)
                ...
                bloc.initView(bloc.memberList, bloc.fileModelUI.channels, bloc.fileModelUI.groups,
                    bloc.fileModelUI.messages1x1, null, null,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              TXTextWidget(
                text: Injector.instance.inMemoryData.currentWhiteBrandConfig != null ? Injector.instance.inMemoryData.currentTeam?.titleFixed.toUpperCase() ?? "" : R.string.appName.toUpperCase(),
                color: Colors.black,
              ),
              // SizedBox(
              //   width: 10,
