...
class EditTeamBloC extends BaseBloC
  ...
  ITeamRepository _iTeamRepository;
  ...
  BehaviorSubject<int> _pageTabController = BehaviorSubject.seeded(0);
  Stream<int> get pageTabResult => _pageTabController.stream;

  BehaviorSubject<TeamModel> _teamController = BehaviorSubject();
  Stream<TeamModel> get teamResult => _teamController.stream;

  BehaviorSubject<UsageModel> _teamUsageController = BehaviorSubject();
  Stream<UsageModel> get teamUsageResult => _teamUsageController.stream;

  BehaviorSubject<bool> _saveButtonSettingsController =
      BehaviorSubject.seeded(false);
  Stream<bool> get saveButtonSettingsResult =>
      _saveButtonSettingsController.stream;

  BehaviorSubject<bool> _saveButtonThemeController =
      BehaviorSubject.seeded(false);
