...
class MessageModel {
  ...
  bool get isNoysiRobotMessage => uid == RemoteConstants.nosyiRobot;
...
class ReactionsModel {
  ...
  static List<ReactionsModel> getReactions() {
    final base = R.image.reactionBase;
    List<ReactionsModel> reactions = [];
    reactions.add(ReactionsModel(reactionKey: "${base}1F600.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F601.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F62C.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F602.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F605.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F613.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F618.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F60D.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F60E.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F614.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F616.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F622.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F62D.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F621.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F592.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F593.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F44F.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F58F.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F590.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F4AA.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F480.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F47B.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F389.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F441.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F4A9.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F575.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F445.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}274E.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}2705.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0030-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0039-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0031-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0032-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0033-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0034-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0035-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0036-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0037-20E3.gif", userIds: []));
    reactions
        .add(ReactionsModel(reactionKey: "${base}0038-20E3.gif", userIds: []));
    reactions.add(ReactionsModel(reactionKey: "${base}1F51F.gif", userIds: []));
    return reactions;
  }
}
