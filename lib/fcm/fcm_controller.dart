...
class FCMController extends IFCMController {
  ...
  void _initLocalNotifications() async {
    ...
    var initializationSettingsAndroid =
        new AndroidInitializationSettings('@mipmap/logo_white');
  ...
  void _initFirebaseMessaging() async {
    ...
    FirebaseMessaging.onMessageOpenedApp
        .listen((RemoteMessage message) => onResume(message.data));
  ...
  static Future _showCommonNotification(FCMMessageModel model) async {
    ...
    var platformChannelSpecificsIos =
        new DarwinNotificationDetails(presentSound: model.sound.isNotEmpty);
  ...
  static void _showCallNotificationIOS(
    ...
    if (!showMissedCall &&
      ...
      var platformChannelSpecificsAndroid = new AndroidNotificationDetails(
          ...
          styleInformation: bigTextStyleInformation);
      // @formatter:on
      var platformChannelSpecificsIos = new DarwinNotificationDetails(
